// server/api/contributor/pending-word/[slug].get.js
...
export default defineEventHandler(async (event) => {
  ...
  try {
    const [rows] = await connection.query(
      ...
      LEFT JOIN pending_words_translations t
    ...
    console.error("Erreur GET pending-word par slug :", err);
