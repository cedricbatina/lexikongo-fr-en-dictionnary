...
function getRuntimeConfig() {
  // useRuntimeConfig est disponible côté serveur Nitro (ESM)
...
function getJwtSecret() {
  ...
  if (!secret) {
    throw new Error(
      "JWT secret manquant (runtimeConfig.jwtSecret ou JWT_SECRET)."
    );
  }
  return secret;
}
...
/**
 * Guard à utiliser dans des endpoints protégés si besoin.
 */
